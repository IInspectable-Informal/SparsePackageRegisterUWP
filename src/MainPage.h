...
namespace winrt::SparsePackageRegisterUWP::implementation
{
    struct MainPage : MainPageT<MainPage>
    {
        ...
        private:
            ...
            fire_and_forget RegisterSprasePackage(SparsePackageRegisterUWP::Dialog const&, IInspectable const&);
...
namespace winrt::SparsePackageRegisterUWP::factory_implementation
{
